...
public class UserInterface {
    ...
    private void displayMainMenuOptions() {
        ...
        System.out.println("    ================================================================================");
        System.out.println();
        System.out.println("        [1]  📚 Music Library      → Browse and search your music collection");
        System.out.println();
        System.out.println("        [2]  📝 Playlist Manager   → Create, edit and organize your playlists");
        System.out.println();
        System.out.println("        [3]  ▶️  Audio Player       → Start listening to your favorite music");
        System.out.println();
        System.out.println("        [4]  👥 Social Features    → Follow friends and discover new music");
        System.out.println();
        System.out.println("        [5]  🚪 Logout             → Sign out and return to welcome screen");
        System.out.println();
        System.out.println("    ================================================================================");
        System.out.println();
